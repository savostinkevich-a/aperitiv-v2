    ...
    <Container className={s.contactsWrapper} fluid={'md'} id='contacts'>
      ...
      <Row className={s.iconsWrapper} xs={2} sm={4}>
        ...
        <a className={s.iconContainer}>
          <svg className={s.icon} width="40" height="40" viewBox="0 0 40 40" fill="none"
            ...
            <path
              ...
              stroke="#DDD6CE"  />
            <path d="M13.75 21.0738L35.0175 5.71387" stroke="#DDD6CE" />
            <path
        ...
        <a className={s.iconContainer}>
          <svg className={s.icon} width="40" height="40" viewBox="0 0 40 40" fill="none"
               xmlns="http://www.w3.org/2000/svg">
            <path d="M35 8.75L20 22.5L5 8.75" stroke="#DDD6CE" />
            <path
              ...
              stroke="#DDD6CE" />
            <path d="M17.2728 20L5.38547 30.8967" stroke="#DDD6CE" />
            <path d="M34.6146 30.8968L22.7271 20" stroke="#DDD6CE" />
          </svg>
          hello@gmail.com
        </a>
      </Row>
